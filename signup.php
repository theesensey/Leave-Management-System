        ...
        <div class="container">
            <form name="myForm" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="form-control">
                    <button class="form-button" type="submit" class="btn btn-primary">Sign Up Now</button>
                </div>
                <br>
                <div class="panel-footer">Have an account with us <a href="login.php">Login</a></div>
            </form>
        </div>
    </div>
    <script>
